                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        <li>
                          <ul
                            role="list"
                            className="-mx-2 space-y-1 max-w-sm animate-pulse"
                          >
                            <li className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4"></li>
                            <li className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[360px] mb-2.5"></li>
                            <li className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></li>
                            <li className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[330px] mb-2.5"></li>
                            <li className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[300px] mb-2.5"></li>
                            <li className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[360px]"></li>
                          </ul>
                        </li>
